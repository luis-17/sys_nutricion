(function() {
  ...
  function PacienteController($scope,$uibModal,$window,$timeout,$filter, uiGridConstants,$document,$state,$stateParams,$location,alertify,
    pageLoading,pinesNotifications,
    ModalReporteFactory,
