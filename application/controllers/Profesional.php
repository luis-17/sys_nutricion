...
class Profesional extends CI_Controller {
	...
	public function registrar_profesional()
	{
    	...
    	if(!empty($allInputs['Base64Img'])){
    		...
    		subir_imagen_Base64($allInputs['Base64Img'], $this->sessionVP['directorio'].'profesionales/' ,$allInputs['nombre_foto']);
    	}
	...
	public function subir_foto_profesional(){
    	...
    	if(!empty($allInputs['croppedImage'])){
    		...
    		subir_imagen_Base64($allInputs['croppedImage'], $this->sessionVP['directorio'].'profesionales/' ,$allInputs['nombre_foto']);
